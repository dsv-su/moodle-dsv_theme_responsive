...
This document describes how to copy and customise the dsv_theme_responsive (bootstrapbase) theme so that
...
From your Moodle theme directory right click on dsv_theme_responsive and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of dsv_theme_responsive.
...
underscores. For the purpose of this tutorial we will call the theme 'dsv_theme_responsivetheme'.

On opening 'dsv_theme_responsivetheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_dsv_theme_responsive.php
...
where the old theme name occurs, in this case dsv_theme_responsive. So using the above list as
a guide, search through and change all the instances of the theme name
'dsv_theme_responsive' to 'dsv_theme_responsivetheme'. This includes the filename of the lang/en/theme_dsv_theme_responsive.php.
You need to change this to 'theme_dsv_theme_responsivetheme.php'.
...
and then click on (dsv_theme_responsivetheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the dsv_theme_responsive theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > dsv_theme_responsive
